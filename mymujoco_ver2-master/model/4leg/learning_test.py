    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.single_action_space = Box(low=-np.inf, high=np.inf, shape=(6,), dtype=np.float32 )
        self.action_size = 6
        self.action_low = -1.0
        self.action_high = 1.0

        xml_path = os.path.join(os.path.dirname(__file__), "half_cheetah_test.xml")
        ...
        MujocoEnv.__init__(
            self, xml_path, 5, observation_space=self.single_observation_space, render_mode="human",**kwargs
        )
